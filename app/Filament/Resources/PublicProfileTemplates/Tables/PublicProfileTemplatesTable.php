...
namespace App\Filament\Resources\PublicProfileTemplates\Tables;
...
class PublicProfileTemplatesTable
{
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('description')
                    ...
                    ->searchable()
                    ->toggleable(),
                ConfirmableToggle::make('is_active', PublicProfileTemplateResource::class, 'Active')
                    ->sortable(),
                ConfirmableToggle::make('is_default', PublicProfileTemplateResource::class, 'Default')
                    ->sortable(),
